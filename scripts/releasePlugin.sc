...
def release(
  ...
  val body = requests.get(
    "https://api.github.com/repos/disneystreaming/weaver-intellij/releases/tags/" + tagName,
  ...
  val uploadUrl =
    s"https://uploads.github.com/repos/disneystreaming/weaver-intellij/releases/" +
